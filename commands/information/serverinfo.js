                ...
                embeds: [
                    new MessageEmbed()
                        ...
                        .addFields([
                            {
                                name: '__About__',
                                value: `**Name**: ${guild.name} \n **ID**: ${guild.id} \n **Owner <a:Crown_01_Owner:1323224315272888353>:** <@!${guild.ownerId}> (${guild.ownerId})\n**Created at:** <t:${parseInt(createdTimestamp / 1000)}:R>\n**Members: **${guild.memberCount}\n**Banned Members: **${bans}`
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: `${booster[guild.premiumTier]} [<a:money_fd:1323225048617586718> ${guild.premiumSubscriptionCount || '0'} Boosts]`
                            },
                            {
